...
import {Pension, SearchedPension, SearchedPensionStatus} from '../modules/pension/pension.entity.js';
...
export class DatabaseSeeder extends Seeder {
  async run(em: EntityManager): Promise<void> {
    ...
    em.create(SearchedPension, {
      ...
      policyNumber: null,
      annualFee: null,
      status: SearchedPensionStatus.FOUND,
      previousName: null,
      previousAddress: '12 Something St',
      annualInterestRate: 0.02,
      defaultAnnualInterestRate: 0.02,
